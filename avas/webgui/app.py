...
from avas.webgui import bridge, server, settings as settings_mod, webview2
...
def main(argv=None, language=None):
    ...
    from avas.webgui import logbridge
    logbridge.install()
    ...
    import webview
    from avas.webgui import services  # noqa: F401 - registers RPC handlers
